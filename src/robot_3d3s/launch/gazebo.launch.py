...
def generate_launch_description():
    ...
    # Set directly so the value is in the environment before any child process forks
    existing_gz_path = os.environ.get('GZ_SIM_RESOURCE_PATH', '')
    os.environ['GZ_SIM_RESOURCE_PATH'] = (existing_gz_path + ':' + models_path) if existing_gz_path else models_path
